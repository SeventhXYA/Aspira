    ...
    <div class="container max-w-screen-xl mb-16">
        <div class="row justify-center">
            <div class="col-12">
                ...
                <div class="card lg:w-full my-4 mx-2 min-h-screen shadow-xl text-black">
                    <div class="card-body mx-2">
                            ...
                            @foreach ($dailybp as $bp)
                                <div class="text-center border my-3">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mt-2">
                                            <label for="viewModal-{{ $bp->id }}" class="btn btn-primary text-white"><i
