            ...
            <div class="col-12">
                ...
                <div class="card lg:w-full mt-4 mx-2 bg-white shadow-xl text-black">
                    ...
                    @elseif ($bp->progress >= 50)
                        <div class="progress h-5 my-2 progress-sm">
                            <div class="progress-bar bg-yellow-400" style="width: {{ $bp->progress }}%">
                                <label class="text-md font-semibold">{{ $bp->progress }}%</label>
                            </div>
                        </div>
                    @elseif ($bp->progress >= 25)
                        <div class="progress h-5 my-2 progress-sm">
                            <div class="progress-bar bg-orange-500" style="width: {{ $bp->progress }}%">
                                <label class="text-md font-semibold">{{ $bp->progress }}%</label>
                            </div>
                        </div>
                    @else
                        <div class="progress h-5 my-2 progress-sm">
                            <div class="progress-bar bg-red-500" style="width: {{ $bp->progress }}%">
                                <label class="text-md font-semibold">{{ $bp->progress }}%</label>
                            </div>
                        </div>
                        @endif
                        ...
                        <label for="viewModal-{{ $bp->id }}" class="modal cursor-pointer">
                            <label class="modal-box relative bg-white">
                                ...
                                <h5 class="modal-title font-bold text-sm uppercase" id="viewModalLabel">
                                    Tanggal Laporan: {{ $bp->created_at->format('Y-m-d') }}
                                </h5>
                                <div class="my-4 ">
                                ...
                                <div class="form-control">
                                    ...
                                    @if ($bp->progress == 100)
                                        <div class="progress h-5 my-2 progress-sm">
                                            <div class="progress-bar bg-green-500" style="width: {{ $bp->progress }}%">
                                                <label class="text-md font-semibold">{{ $bp->progress }}%</label>
                                            </div>
                                        </div>
                                    @elseif ($bp->progress >= 75)
                                        <div class="progress h-5 my-2 progress-sm">
                                            <div class="progress-bar bg-lime-500" style="width: {{ $bp->progress }}%">
                                                <label class="text-md font-semibold">{{ $bp->progress }}%</label>
                                            </div>
                                        </div>
                                </div>
