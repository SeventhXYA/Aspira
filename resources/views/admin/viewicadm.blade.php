                                ...
                                @foreach ($dailyic as $ic)
                                    <tbody class="divide-y uppercase divide-gray-100 ">
                                        <tr>
                                            ...
                                            <td class="p-3 text-xs text-gray-700">
                                                {{ $ic->user->firstname }} {{ $ic->user->lastname }}
                                            </td>
                                            <td class="p-3 text-xs text-gray-700">
                                            ...
                                            <label for="viewModal-{{ $ic->id }}" class="modal cursor-pointer">
                                                <label class="modal-box relative bg-white">
                                                    ...
                                                    <p class="modal-title font-bold text-sm uppercase"
                                                        id="viewModalLabel">
                                                        Dibuat Tanggal: {{ $ic->created_at->format('Y-m-d') }}
                                                    </p>
                                                    ...
                                                    <div class="form-control inline-block">
                                                        ...
                                                        <input class="input bg-none w-24 uppercase text-xs font-semibold"
                                                            value="{{ $ic->timestart }}" readonly /> s/d <input
                                                            class="input bg-none w-24 uppercase text-xs font-semibold"
                                                            value="{{ $ic->timefinish }}" readonly />
                                                    </div>
                                                    <div class="form-control">
                                                        <label class="label">
                            ...
                            <div class="grid grid-cols-1 gap-4 md:hidden my-1" data-theme="cmyk">
                                <div class="bg-white p-4 border-2 border-gray-200 rounded-lg shadow-lg">
                                    <div class="flex items-center space-x-2 justify-between">
                                        <span
                                            class="bg-green-500 rounded-lg text-xs text-white font-bold p-1 m-1 uppercase">{{ $ic->created_at->format('Y-m-d') }}</span>
                                        <div>
                                            @if ($ic->progress == 100)
                                                <span
                                    ...
                                    <div class="flex items-center space-x-2 text-sm"> <a href="#"
                                            class="font-bold hover:underline">{{ $ic->user->firstname }}
                                            {{ $ic->user->lastname }}</a></div>
