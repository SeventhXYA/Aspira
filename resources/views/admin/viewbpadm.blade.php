                ...
                <div class="card lg:w-full mt-4 mx-2 bg-white shadow-xl text-black">
                    <div class="card-body mx-2">
                        <div class="flex justify-end mb-4">
                            <a href="{{ route('dailybppdf') }}" target="_blank" class="btn btn-primary text-white">
                            ...
                            <div class="grid grid-cols-1 gap-4 md:hidden">
                                <div class="bg-cyan-700 text-white p-4 rounded-lg shadow">
                                    ...
                                    <div class="flex items-center space-x-2 text-sm">
                                        <div class="text-gray-100">{{ $bp->created_at->format('d-M-Y') }}</div>
                                        <div>
                                            @if ($bp->progress == 100)
                                                <strong><span
                                                        class="bg-green-500 rounded-lg text-xs text-white p-1 m-1 uppercase">Terselesaikan</span></strong>
                                    ...
                                    <div class="text-sm text-gray-100 my-2">{{ $bp->plan }}</div>
                                    ...
                                    <label class="modal-box relative bg-white">
                                        ...
                                        <div class="form-control">
                                            ...
                                            <input type="text" class="input bg-white w-full max-w-xs "
                                                value="{{ $bp->user->firstname }} {{ $bp->user->lastname }}" readonly />
                                        </div>
                                        <div class="form-control">
                                            <label class="label">
                                                <h4><strong>Divisi:</strong></h4>
